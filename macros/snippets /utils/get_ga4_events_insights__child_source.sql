...
{%- set event_types_renamed = dbt_utils.get_column_values(ref('_stg_ga4_events'),'event_name',order_by='event_name asc') -%}
{%- set event_types_number = dbt_utils.get_column_values(ref('_stg_ga4_events'),'dup_event_name_nb',order_by='event_name asc') -%}
